# modyfikacja: dodajemy alfę jako stopień niedopuszczalności
# im większa, tym znajduje dłuższe ścieżki, co widać po testach
# co to daje - lepsza wydajność, ale dłuższe ścieżki
